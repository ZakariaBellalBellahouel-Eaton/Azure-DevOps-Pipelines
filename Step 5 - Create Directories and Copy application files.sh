...
cp $SYSTEM_ARTIFACTSDIRECTORY/_PXMC3000-data-agent/PXMC3000-data-agent/PXMC3000-data-agent  /proc/$(sudo lxc-info -n $CONTAINERNAME -p -H)/root/$CONTAINERDATAAGENTDIRECTORY/$CONTAINERPXMC3000DATAAGENTSERVICENAME
